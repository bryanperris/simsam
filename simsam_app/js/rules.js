...
(function() {
  ...
  window.Rule = (function() {
    function Rule(spriteType1) {
      this.spriteType = spriteType1;
      this.action = null;
      this.type = '';
      this.typeint = -1;
    }
  ...
  window.Interaction = (function(superClass) {
    extend(Interaction, superClass);
    ...
    Interaction.prototype.act = function(sprite, iObj, environment) {
      var minCount, ref, shouldAct, spriteType;
      shouldAct = true;
      ref = this.requiredEnvironment;
      for (spriteType in ref) {
        minCount = ref[spriteType];
  ...
  window.OverlapInteraction = (function(superClass) {
    extend(OverlapInteraction, superClass);
  ...
  window.ruleBuildJSON = function(ruleArray, rulesOutput) {
    var json, results, rule, ruleSet, setArray, setKey, spriteTypeKey;
    results = [];
    for (spriteTypeKey in ruleArray) {
      ruleSet = ruleArray[spriteTypeKey];
      setArray = [];
      ...
      results.push(rulesOutput[spriteTypeKey] = setArray);
    }
    return results;
  };
