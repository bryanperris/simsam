...
(function() {
  $(function() {
    var anyCamera, cameraOff, cameraOn, cameraState, cameraSwitch, capture, clearPlayback, frameBack, frameBeginning, frameEnd, frameForward, frameRegistry, getRandomId, loadFrames, makeSortable, makeUnselectable, menu, overlayClass, pause, placeFrame, playbackClass, playbackTimeouts, recording, rescanThumbnails, saveCanvas, saveFrameSequence, startSamlite, startSimlite, thumbnailScaleFactor, toggleCamera, toggleMenu, toggleMode, trash;
    ...
    window.initSam = function() {
      var element, failure, i, j, len, len1, ref, ref1, success;
    ...
    saveFrameSequence = function() {
      ...
      frameSequence = (function() {
        var i, len, results;
        results = [];
        for (i = 0, len = playbackFrames.length; i < len; i++) {
          frame = playbackFrames[i];
          results.push($(frame).attr("data-frame-id"));
        }
        return results;
      })();
      ajaxOptions = {
    ...
    window.play = function() {
      ...
      for (index = i = 0, len = playbackFrames.length; i < len; index = ++i) {
    ...
    pause = function() {
      ...
      window.isPlaying = false;
      results = [];
      for (i = 0, len = playbackTimeouts.length; i < len; i++) {
        timeout = playbackTimeouts[i];
