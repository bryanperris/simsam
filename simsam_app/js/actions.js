...
(function() {
  ...
  window.DeleteAction = (function(superClass) {
    extend(DeleteAction, superClass);
  ...
  window.CloneAction = (function(superClass) {
    extend(CloneAction, superClass);
  ...
  window.SproutAction = (function(superClass) {
    extend(SproutAction, superClass);
  ...
  window.TransformAction = (function(superClass) {
    extend(TransformAction, superClass);
